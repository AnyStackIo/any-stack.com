                ...
                <div className="max-w-6xl mx-auto px-8">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl md:text-5xl font-semibold mb-6 tracking-tight">
                            Why Work at <span className="text-blue-400">AnyStack</span>
                        </h2>
                    </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <JobListing
                            ...
                            responsibilities={[
                                ...
                                "Contribute to open-source tools and AnyStack's technical blog",
            ...
            <section className="py-20">
                <div className="max-w-4xl mx-auto px-8 text-center">
                    ...
                    <Button
                        ...
                        onClick={() => window.location.href = 'mailto:careers@AnyStack.com?subject=Application - Principal DevOps Engineer'}
                    >
                        Apply Now
                ...
                <div className="px-8 pb-8 border-t border-white/10">
                    ...
                    <div className="mt-8 pt-6 border-t border-white/10">
                        <Button
                            ...
                            onClick={() => window.location.href = `mailto:careers@AnyStack.com?subject=Application - ${title}`}
                        >
